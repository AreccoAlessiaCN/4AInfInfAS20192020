...
//PADRE --> tutti i suoi metodi e i suoi attributi finiscono ai figli
// il padre generalizza il figlio
public class Nave {
    ...
    public static void caricaNave (Nave elencoNavi[], int cntNave) {

        int tipoNave;
        System.out.println("\nDati nave: ");
        do {
            System.out.println("Tipo nave (0 : passeggeri / 1 : merci) :");
            tipoNave = InputOutputUtility.leggiNumero();
        }
        ...
        if (tipoNave == Nave.NAVE_PASSEGGERI) {
            ...
            ( (NavePasseggeri)elencoNavi[cntNave] ).setNumPasseggeri(InputOutputUtility.leggiNumero());
        }
        else {
        ...
        elencoNavi[cntNave].setDataArrivo(InputOutputUtility.leggiData());
        System.out.println("Attracco numero: ");
        elencoNavi[cntNave].setNumeroPosizioneAttracco(InputOutputUtility.leggiNumero());
        System.out.println("Compagnia:");
        elencoNavi[cntNave].setCompagnia(InputOutputUtility.leggiNome());
    }

    public String toString() {
        String descTipoNave = this.tipoNave==Nave.NAVE_PASSEGGERI ? "PASSEGGERI" : "MERCI";
        String s = ("Tipo Nave: "+descTipoNave+" Lunghezza: " +lunghezza+ " Larghezza: " +larghezza+ " Data arrivo: " +
