        ...
        do
        {
            ...
            switch (scelta) {
                ...
                case 4:
                    ...
                    porto.findNaveInPortoByDataPartenza((java.sql.Date) InputOutputUtility.leggiData());
                    break;
                case 5:
                    System.out.println("Inserisci lunghezza (###.##): ");
                    porto.findNaveInPortoByLunghezza(InputOutputUtility.leggiNumeroFloat());
                    break;
                case 6:
                    System.out.println("Inserisci l'attracco: ");
                    int attracco = InputOutputUtility.leggiNumero();
